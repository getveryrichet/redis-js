...
//https://coderedirect.com/questions/275020/how-to-get-all-keys-and-values-in-redis-in-javascript
// async로 되는 부분때문에 바로 리턴이 안되는 이슈보려면 여기서

key = "hasdfasdfd"

client.hincrby(key, "richet", 1, function(err, val) {
    console.log("increased by", val);
});

client.hget(key, "richet",function(err, val) {
    console.log("get", val);
});